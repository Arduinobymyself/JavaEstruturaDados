...
faça a conversão de números decimais para bonário
 */
...
public class Exerc07 {
    public static void main(String[] args) {
        ...
        imprimeResultado(10);
        imprimeResultado(25);
        imprimeResultado(255);
        imprimeResultado(10035);

        imprimeResultadoQualquerBase(2, 16);
        imprimeResultadoQualquerBase(4, 8);
        imprimeResultadoQualquerBase(10, 16);
        imprimeResultadoQualquerBase(25, 16);
        imprimeResultadoQualquerBase(255, 16);
        imprimeResultadoQualquerBase(255, 8);
